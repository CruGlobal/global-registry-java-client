...
public abstract class AbstractGlobalRegistryClient implements GlobalRegistryClient {
    ...
    @Override
    public final <T> T getEntity(final Type<T> type, final String id, final Filter... filters) {
    ...
    @Override
    public final <T> ResponseList<T> getEntities(final Type<T> type, final String ownedBy, final int page,
                                                 final int perPage, final Filter... filters) {
    ...
    @Override
    @Deprecated
    public final <T> void deleteEntity(final Type<T> type, @Nonnull final String id) {
        this.deleteEntity(id);
    }

    @Override
    public final <T> T addEntity(@Nonnull final Type<T> type, @Nonnull final T entity) {
    ...
    @Override
    public final ResponseList<MeasurementType> getMeasurementTypes(final Filter... filters) {
    ...
    public List<Measurement> getMeasurements(final MeasurementType type, final ReadableInstant from,
                                             final ReadableInstant to, final Filter... filters) {
    ...
    @Override
    public final List<Measurement> getMeasurements(final MeasurementType type, final Filter... filters) {
        return this.getMeasurements(type.getId(), filters);
    }

    @Override
    public final List<Measurement> getMeasurements(final String type, final Filter... filters) {
