...
public interface GlobalRegistryClient {
    ...
    <T> ResponseList<T> findEntities(Type<T> type, Filter... filters);

    <T> ResponseList<T> findEntities(Type<T> type, int page, Filter... filters);

    <T> ResponseList<T> findEntities(Type<T> type, String createdBy, Filter... filters);

    <T> ResponseList<T> findEntities(Type<T> type, String createdBy, int page, Filter... filters);
